...
class Tab extends React.Component {
  ...
  handlePull = () => {
    ...
    API.GET(url,{ page:this.page,num:this.num }).then((data) => {
  ...
  handleSearch = () => {
    ...
    API.GET('search/my_approve',{ page:this.page,num:this.num ,cates:cates,status:this.state.status,keyword:this.state.search}).then((data) => {
      console.log('搜索列表数据')
  ...
  handleUpdate = (text) => {
    ...
    let url = '';
    switch (text.type) {
      case 'qj': url = 'leaves/approval'; Object.assign(text,{ApplyId:text.Leaveid});break
      case 'jb': url = 'overtimes/approval';Object.assign(text,{ApplyId:text.Overtimeid}); break
      case 'bx': url = 'expenses/approval';Object.assign(text,{ApplyId:text.Expenseid}); break
      case 'cc': url = 'businesstrips/approval';Object.assign(text,{ApplyId:text.Businesstripid}); break
      case 'wc': url = 'goouts/approval';Object.assign(text,{ApplyId:text.Gooutid}); break
      case 'wp': url = 'oagoods/approval';Object.assign(text,{ApplyId:text.Oagoodid}); break
    }
